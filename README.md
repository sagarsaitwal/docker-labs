...
<p align="center">
  <a href="https://github.com/YOUR-USERNAME/docker-labs/actions/workflows/ci.yml">
    <img alt="CI" src="https://github.com/YOUR-USERNAME/docker-labs/actions/workflows/ci.yml/badge.svg">
  </a>
...
|:--:|---|:--:|---|
| 0 | Engine install, daemon, socket permissions | ✅ | [journal](JOURNAL.md#day-0--environment-setup-fedora-44-on-wsl2) |
| 1 | Containers: `run`, `ps`, `logs`, `exec`, `rm` | ✅ | [journal](JOURNAL.md#day-1--containers-run-inspect-exec-destroy) |
| 2 | Environment variables, `--rm`, restart policies | ⬜ | |
| 3 | Images, tags, digests, registries | ⬜ | |
| 4 | Writing a first Dockerfile | ⬜ | |
| 5 | Layer caching and `.dockerignore` | ⬜ | |
| 6 | Named volumes and data persistence | ⬜ | |
| 7 | Bind mounts and live-reload development | ⬜ | |
| 8 | Networks and container DNS | ⬜ | |
| 9 | Docker Compose | ⬜ | [example](examples/first-stack/) |
| 10 | Multi-service stack with healthchecks | ⬜ | [project 01](projects/01-node-postgres/) |
| 11 | Debugging: exit codes, logs, `inspect` | ⬜ | |
| 12 | Multi-stage builds and image size | ⬜ | [project 03](projects/03-react-multistage/) |
| 13 | Publishing to a registry | ⬜ | |
| 14 | Production hardening: non-root, limits, scanning | ⬜ | |
...
```bash
git clone https://github.com/YOUR-USERNAME/docker-labs.git
cd docker-labs
...
| **Validate Compose files** | `docker compose config` renders each file — catches syntax and interpolation errors before runtime |
